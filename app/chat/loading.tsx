...
export default function ChatLoading() {
  return (
    <div className="mx-auto max-w-md p-4 animate-pulse">
      ...
      <div className="flex flex-col h-[calc(100vh-9rem)] max-h-[700px]">
        <div className="flex-1 space-y-4 pb-2">
          ...
          <div className="flex justify-start gap-2">
            <div className="size-7 rounded-full bg-emerald-100 flex items-center justify-center shrink-0 mt-1">
        ...
        <div className="flex gap-2 pt-2 border-t border-slate-100">
          ...
          <div className="size-11 bg-slate-100 rounded-2xl" />
        </div>
      </div>
    </div>
  );
