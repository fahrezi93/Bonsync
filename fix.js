...
const newHomePage = `export default async function HomePage() {
...
const idx = code.indexOf('export default async function HomePage() {');
if (idx > -1) {
  code = code.substring(0, idx) + newHomePage;
